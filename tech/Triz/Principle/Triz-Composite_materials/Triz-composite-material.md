...
[TrizPrinciple::[[Triz-Composite_materials]]]

Change from uniform to composite (multiple) materials.

## Examples: 

- #has_/examples :: Composite Epoxy Resin/Carbon Fiber Golf Club Shafts are lighter, stronger, and more flexible than Metal. Same for airplane Parts like Wings etc.
- #has_/examples :: Fiberglass Surfboards are lighter and more controllable and easier to form into a variety of Shapes than wooden ones. 
- #has_/examples :: 
- 
